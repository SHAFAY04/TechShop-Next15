  ...
  return (
    <div className="bg-img min-h-screen flex flex-col md:flex-row justify-center items-center gap-10 md:gap-28 lg:gap-96">
      ...
      <div className="head-1 flex md:flex-col gap-14 md:gap-10 lg:gap-20 text-green-700 customfont">
        <h1 className={`${anton.className} scale-x-200 scale-y-160 md:scale-x-180 md:scale-y-170 lg:scale-x-250 lg:scale-y-200`}>D</h1> 
        <h1 className={`${anton.className} scale-x-200 scale-y-160 md:scale-x-180 md:scale-y-170 lg:scale-x-250 lg:scale-y-200`}>A</h1>
        <h1 className={`${anton.className} scale-x-200 scale-y-160 md:scale-x-180 md:scale-y-170 lg:scale-x-250 lg:scale-y-200`}>V</h1>
      ...
      <main className="flex justify-center items-center">
        <div className="rounded-2xl p-10 min-w-sm max-w-sm text-center bg-black text-2xl text-white">
          <h1 className="italic text-3xl">The Shafay's Computer Shop</h1>
